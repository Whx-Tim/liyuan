        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="breadcrumb breadcrumb-1">
                    ...
                    <li><a href="{{ url('partTime/detail/'.$partTime->id) }}"><i class="fa fa-file"></i>兼职详情</a></li>
                    <li class="active"><span>编辑兼职信息</span></li>
                </div>
                <div class="panel-body">
                    <form action="{{ url('partTime/edit/'.$partTime->id) }}" method="post" class="form-horizontal" role="form">
                        {{ csrf_field() }}
                        {{ method_field('patch') }}
                        ...
                        <hr>
                        <div class="col-md-6">
                            <a href="{{ url('partTime/detail/'.$partTime->id) }}" class="btn btn-block btn-danger btn-radius">返回</a>
                        </div>
                        <div class="col-md-6">
