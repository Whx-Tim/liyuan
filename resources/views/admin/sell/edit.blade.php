...
@section('title','编辑二手交易')

@section('breadcrumb')
    <li><a href="{{ url('admin/sell') }}"><i class="fa fa-archive"></i>二手交易</a></li>
    <li class="active"><span><i class="fa fa-file"></i>编辑二手交易</span></li>
@stop
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="{{ url('admin/sell/edit/'.$sell->id) }}" class="form-horizontal" method="post" role="form" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    {{ method_field('patch') }}
                    ...
                    <div class="col-md-4 col-md-offset-2">
                        <a href="{{ url('admin/sell') }}" class="btn btn-danger btn-radius btn-block">返回</a>
                    </div>
                    <div class="col-md-4">
