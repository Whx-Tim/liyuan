...
@section('breadcrumb')
    ...
    <li class="active"><span><i class="fa fa-file"></i>编辑快递帮取</span></li>
@stop
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="{{ url('admin/transport/edit/'.$transport->id) }}" method="post" class="form-horizontal" role="form">
                    {{ csrf_field() }}
                    {{ method_field('patch') }}
                    ...
                    <div class="col-md-6"><a href="{{ url('admin/transport') }}" class="btn btn-danger btn-radius btn-block">返回</a></div>
                    <div class="col-md-6">
